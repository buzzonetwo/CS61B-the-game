...
public class TERenderer {
    ...
    public void drawTileInfo(TETile[][] tiles, int score) {
        StdDraw.setFont(new Font("Monaco", Font.BOLD, TILE_SIZE - 2));
        renderFrame(tiles);

        try {
            StdDraw.setFont(new Font("Monaco", Font.BOLD, 20));
            String s = tiles[(int) Math.floor(StdDraw.mouseX()) - xOffset]
                    [(int) Math.floor(StdDraw.mouseY()) - yOffset].description();
            String flavor;
            if (s.equals("mountain")) {
                s = "You";
                flavor = "There is no need to learn about yourself";
                ...
                s = "Flower";
                flavor = "My precious flower";
            } else if (s.equals(Tileset.WATER.description())) {
                s = "The Exit";
                flavor = "The destined land";
            } else {
                s = "The Void";
                flavor = "/$@##@$!";
            }
            StdDraw.setPenColor(StdDraw.BOOK_LIGHT_BLUE);
            StdDraw.filledRectangle(0, 60, 30, 12);
            StdDraw.setPenColor(StdDraw.BLACK);
            StdDraw.setFont(new Font("Arial", Font.BOLD, 20));
            StdDraw.textLeft(2, 55, s);
            StdDraw.setFont(new Font("Arial", Font.BOLD, 12));
            StdDraw.textLeft(2, 53, flavor);
            StdDraw.setPenColor(StdDraw.PINK);
            StdDraw.textLeft(2, 50, "Score: " + score);
            ...
            StdDraw.setPenColor(StdDraw.BLACK);
            StdDraw.setFont(new Font("Arial", Font.BOLD, 20));
            StdDraw.textLeft(2, 55, "The Deep Void");
            StdDraw.setFont(new Font("Arial", Font.BOLD, 12));
            StdDraw.textLeft(2, 53, "/$@^$#@%#$%@#$1##@$!");
            StdDraw.setPenColor(StdDraw.PINK);
            StdDraw.textLeft(2, 50, "Score: " + score);
        } finally {
            StdDraw.show();
